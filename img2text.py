...
parser = argparse.ArugementParser()
...
parser.add_arugement("input_file", help = "path to the original image")

parser.add_argument("color", help = "an interger number of shades of gray to use for the output image (min: 2, max:10)", type = int)
