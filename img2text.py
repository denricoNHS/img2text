...
try:
  ...
  if ncolors not in range(2, 11) or output_width not in range(80,121):
    raise ValueError
  ...
  print("Invalid input for colors:acceptable is number range from 2-10 or invalid input for output_width: acceptable is number range from 80-120")
